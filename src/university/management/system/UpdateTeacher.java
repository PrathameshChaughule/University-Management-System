...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfphone, tfaddress, tfemail, tfbranch;
    JLabel labelEmpId;
    ...
    UpdateTeacher(){
        ...
        labeldob.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(labeldob);
        ...
        labelx.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(labelx);
        ...
        labelxii.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(labelxii);
        ...
        labelaadhar.setFont(new Font("Tahoma", Font.PLAIN, 17));
        add(labelaadhar);
        ...
        try {
            ...
            while(rs.next()){
                ...
                labelxii.setText(rs.getString("class_xii"));labelname.setText(rs.getString("name"));
